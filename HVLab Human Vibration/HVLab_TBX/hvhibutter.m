%hvhibutter - issue 1.3 (22/04/09) - HVLab HRV Toolbox
%-----------------------------------------------------
%[outdata] = hvhibutter(indata, fc, npoles)
% Applies a high-pass Butterworth filter to time histories in HVLab data 
% structure using an identical algorithm to the HVLab_DOS function HIBUTTER
%
...
function [dasOutarr] = hvhibutter(dasInarr, fFc, iPoles)

[dasOutarr] = HVLABFILTER(dasInarr, 'BUTTERWORTH', 'HIGHPASS', fFc, iPoles);
